# Art + Zap Weekend — Sponsor Leave-Behind
...
Federal arts funding is collapsing. The NEA has been targeted for elimination in two consecutive federal budgets, and 2025 saw mass termination of previously approved grants. At the same time, Bitcoin and the Lightning Network have made it possible — for the first time in history — for an audience anywhere in the world to send instant, micro-value payments directly to an artist on stage.

We are not waiting for institutions to decide whether artists deserve funding. We are building a parallel system that is censorship-resistant, globally accessible, and aligned with the values of the Bitcoin community.

**Art + Zap Weekend is the proof of concept.**
...
Small, but high-signal. The Bitcoin + arts overlap is exactly the audience sponsors in this category want to reach:

- **High intent.** Bitcoiners actively support brands that show up early in the Bitcoin economy.
- **Global.** Active communities in the Americas, Europe, Africa, and LATAM — all reachable in the 1–5 pm ET window.
- **Loyal.** Bitcoin-native sponsors get long-tail brand recall that traditional ad spend cannot buy.
- **High net worth.** Even a small live audience converts at sponsorship rates well above conventional CPM.
- **Permanent record.** Every segment is clipped, archived on YouTube, and broadcast forever on Nostr — sponsor logos are visible in perpetuity.

---

## The Three Sponsorship Tiers

All tiers are payable in **USD (card / wire / ACH)** or **Bitcoin (on-chain or Lightning)**. Bitcoin For The Arts, Inc. is a registered 501(c)(3); all sponsorships are tax-deductible to the extent allowed by law.

### Title Sponsor — $25,000 (1 available)

**The face of Art + Zap Weekend.** Co-branded as "Art + Zap Weekend, presented by [Sponsor]."

- Naming rights: "Art + Zap Weekend, presented by [Sponsor]" on every stream segment, all marketing, all post-event content
- Logo on the persistent on-screen lower-third for the full 8 hours of broadcast
...
**Major presence across the full weekend.**

- Logo on rotating on-screen lower-third throughout the broadcast
...
### Friend of the Arts — $5,000 (5 available)

**Meaningful brand presence with a low barrier to entry.**
...
> **Stackable:** Sponsors who can't commit to a full tier can split commitments across cash + in-kind (e.g., $3,000 cash + $2,000 in-kind venue/A/V credit = Friend of the Arts). All in-kind valuations are documented for tax and transparency purposes.

---

## In-Kind Sponsorship Options

In-kind support is treated as equivalent value to cash sponsorship at the corresponding tier. We strongly encourage Bitcoin-native businesses, NYC venues, and creative-services vendors who can give in kind.
...
3. **A warm introduction** to one company or individual you believe should sponsor this event
